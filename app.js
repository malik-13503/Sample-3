...
let ucoins = parseInt(localStorage.getItem('ucoins')) || 0;
let betAmount = 0;
...
function handleResult(result) {
    ...
    if (result === userChoice) {
        ...
        ucoins += betAmount;
        message = `🎉 Great choice! You won ${betAmount} Ucoins! 🎁 Keep spinning for more!`;
        isWin = true;
        ...
        ucoins -= betAmount;
        message = `🙁You picked "${userChoice}" but it was "${result}" You lost ${betAmount} Ucoins. Spin again! 🎡.`;
